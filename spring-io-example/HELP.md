...
* The original package name 'com.captech.native-starter' is invalid and this project uses 'com.captech.nativestarter' instead.
...
```
$ docker run --rm -p 8080:8080 native-starter:0.0.1-SNAPSHOT
```
